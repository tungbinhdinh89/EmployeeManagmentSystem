...
{
    internal class CityRepository(ApplicationDbContext dbContext) : IGenericRepositoryInterface<City>
    {
        ...
        public async Task<List<City>> GetAll() => await dbContext.Cities.ToListAsync();
        ...
        {
            var town = await dbContext.Cities.FindAsync(item.Id);
